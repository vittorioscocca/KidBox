...
enum NudgeState {
    ...
    ///
    /// Serve anche in Release — la chiama `KidBoxLocalNotificationsCleanup` — quindi
    /// sta fuori da `#if DEBUG`.
    ...
    /// `installedDaysAgo` giorni fa, così la sequenza riparte senza reinstallare l'app.
