...
| 2 | Inviti e join | link + QR, join di B, chiave di famiglia arrivata (B legge una nota cifrata di A), cancellazione famiglia vuota dell'onboarding, uscita e re-join |
...
| 6 | Chat + Foto/video | messaggi E2E, vocale, album, anteprima notifica |
...
| 11 | AI e gating | assistente (5 msg bonus Free), mealPlan bloccato su Free, Document Intelligence, `isAIAccessible` coerente con `config/plans` |
| 12 | Abbonamento | gating Free/Pro/Max cambiando piano da console admin; **nessun acquisto reale** |
| 13 | Backend | `firestore-tests` rules, Functions in emulatore, scheduler, App Check, alert Monitoring silenziosi |
